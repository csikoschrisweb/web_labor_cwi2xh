...
<!-- Parallax background Fuji mountain -->
<div class="parallax-bg"></div>

<div class="video-wrapper">
    <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/3hEm5Y_74U0" 
        title="Bemutatkozó videó" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="video-container">
        <video width="560" height="315" controls>
            <source src="<?php echo BASE_URL; ?>/public/videos/bemutato.mp4" type="video/mp4">
